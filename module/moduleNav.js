  ...
  view: function() {
    return m("div.schitte-nav", [
      ...
      m("div.schitte-nav-buttons", [
        m("button.schitte-nav-button[onclick='window.open(\"https://sites.google.com/view/schitteindustries\", \"_blank\")']", "Home"),
        m("button.schitte-nav-button[onclick='window.open(\"https://sites.google.com/view/schitteindustries/about\", \"_blank\")']", "About"),
